...
export const ManagerAIChatbotPage: React.FC = () => {
  return (
      ...
      <div className="card card-glow" style={{ padding: '2.5rem 2rem', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '1.25rem' }}>
        ...
        <div>
          ...
          <p style={{ fontSize: '0.875rem', color: 'var(--text-secondary)', margin: 0, lineHeight: 1.5 }}>
            The AI CRM Assistant is now docked as a persistent floating copilot in the <strong>bottom-right corner</strong> across all Lead-IQ pages. Click the glowing AI button anytime to ask about CRM leads, revenue, and predictive intelligence.
          </p>
        </div>

        <a href="#/manager/dashboard" className="btn btn-primary" style={{ marginTop: '0.5rem' }}>
